...
**Chưa test được trên máy Android thật** — cần xác nhận: video vẫn phát/dừng/phóng to bình
thường sau khi đổi cơ chế; thanh trượt âm lượng video hoạt động đúng; và đặc biệt là logic tự
chuyển hướng fullscreen (bấm nút fullscreen CỦA CHÍNH YouTube, không phải nút "Phóng to" của app)
vẫn nhận diện đúng sau khi đổi cách kiểm tra.
...
- **Test lại khối phát video (YouTube IFrame Player API) trên máy Android thật** — xem mục
  "Âm lượng video gốc" phía trên: xác nhận phát/dừng/phóng to/thanh trượt âm lượng đều đúng, và
  đặc biệt logic tự chuyển hướng fullscreen (nút fullscreen CỦA YouTube, không phải nút "Phóng
  to" của app) vẫn nhận diện đúng sau khi đổi cách kiểm tra (không còn dựa vào tham chiếu/id
  iframe cũ).
